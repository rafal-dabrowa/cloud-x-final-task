...
public class Startup
{
    ...
    public void ConfigureProductionServices(IServiceCollection services)
    {
        ...
        services.AddDbContext<CatalogContext>(c =>
            c.UseSqlServer(Configuration.GetValue<string>("CatalogConnection")));

        // Add Identity DbContext
        services.AddDbContext<AppIdentityDbContext>(options =>
            options.UseSqlServer(Configuration.GetValue<string>("IdentityConnection")));
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddOptions<FunctionConfigurations>().Configure(option =>
        {
            option.Url = Configuration.GetValue<string>("DeliverOrderProcessorUrl");
        });

        services.AddOptions<ServiceBusQueueConfiguration>().Configure(options =>
        {
            options.QueueName = Configuration.GetValue<string>("QueueName");
            options.QueueConnectionString = Configuration.GetValue<string>("QueueConnectionString");
        });
